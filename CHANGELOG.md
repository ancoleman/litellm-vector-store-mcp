...
### Added
- **Multi-Platform Docker Images**: Support for both linux/amd64 and linux/arm64
  - Windows (WSL2) - linux/amd64
  - macOS Intel - linux/amd64
  - macOS Apple Silicon (M1/M2/M3) - linux/arm64
  - Linux x86_64 - linux/amd64
  - Linux ARM64 - linux/arm64
- **gcloud Proxy Support**: Documentation for using `http://localhost:5600` with IAP tunnel
- **Platform Auto-Detection**: Docker automatically pulls correct architecture
